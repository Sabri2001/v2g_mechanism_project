...
BASE_CONFIG="../config/tsg/xp_6/cost_savings_vs_naive_line.yaml"
CONFIG_OUTPUT_DIR="../config/tsg/xp_6/generated"
TIMESTAMP=$(date +%Y%m%d_%H%M%S)
PLOT_SCRIPT="../plot_experiments/plot_xp_6.py"
...
for alpha in "${ALPHA_FACTORS[@]}"; do
  for limit in "${EVCS_POWER_LIMITS[@]}"; do
    ...
    sed \
      -e "s|^folder:.*|folder: \"tsg/xp_6/${SUBFOLDER}\"|" \
